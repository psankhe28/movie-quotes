...
function App() {
    ...
    const fetchDropdownOptions = async (query) => {
        try {
            const yearsResponse = await axios.get(`https://movie-quotes-demo.onrender.com/years?query=${query}`);
            setYears(yearsResponse.data);

            const categoriesResponse = await axios.get(`https://movie-quotes-demo.onrender.com/categories?query=${query}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.get(`https://movie-quotes-demo.onrender.com/search?query=${query}`);
